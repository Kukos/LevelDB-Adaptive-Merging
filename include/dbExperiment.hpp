...
class DBExperiment{
    ...
    public:
        ...
        static void experimentWithDBModification(std::string expType, std::ofstream& log, const size_t dataRange, const size_t nmbRec, const size_t nmbQuery, const size_t sel) noexcept(true);
 ...
 //       static void expFullScanDBModification(const std::vector<DBRecord>& records, std::ofstream& log, std::vector<size_t>& queryCount, const size_t nmbRec,  const size_t sel,
